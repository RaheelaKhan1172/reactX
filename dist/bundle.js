...
var ToDo = exports.ToDo = function (_React$Component) {
    ...
    function ToDo(props) {
        ...
        _this.state = { task: "", editing: false, peeking: false };
    ...
    _createClass(ToDo, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                null,
                React.createElement(_Button.Button, { onClick: function onClick() {
                        return "hi";
                    } }),
                React.createElement(_Input.Input, { value: "cool", onChange: function onChange() {
                        return "not";
                    }, name: "test" }),
                React.createElement(_Item.Item, { onEdit: function onEdit() {
                        return "editing";
                    }, editing: false })
            );
        }
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                null,
                this.props.editing ? React.createElement("input", { type: "text" }) : "List"
            );
        }
    }]);
...
ReactDOM.render(React.createElement(_ToDo.ToDo, null), document.getElementById("container"));
