...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(1), __webpack_require__(0), __webpack_require__(2));
...
var _ListModel = __webpack_require__(9);

var _ItemModel = __webpack_require__(8);
...
var _mobxReactDevtools = __webpack_require__(10);
    ...
    _createClass(ToDo, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                "div",
                null,
                this.props.store.peeking && this.props.store.tasksToDo.toDo[1] && this.props.store.tasksToDo.toDo[1].value && React.createElement(_Button.Button, { onClick: this.donePeeking, message: "Done " }),
                this.props.store.peeking && !this.props.store.tasksToDo.toDo[1] && "Nothing else to do!" && React.createElement(_Button.Button, { onClick: this.donePeeking, message: "Done" }),
                this.props.store.tasksToDo.toDo.length > 0 && this.props.store.tasksToDo.toDo[0].value,
                this.props.store.tasksToDo.toDo.length === 0 && "Add some tasks!",
                React.createElement(_Input.Input, { onChange: this.onChange, name: "task", value: this.props.store.task }),
                React.createElement(_Button.Button, { onClick: this.onAdd, message: "Add Task" }),
                React.createElement(_Button.Button, { onClick: this.peek, message: "Peek next" }),
...
var Button = exports.Button = function (_React$Component) {
    ...
    _createClass(Button, [{
        ...
        value: function render() {
            return React.createElement(
                "button",
                { name: this.props.name, onClick: this.onClick },
                this.props.message
            );
        }
    }]);
...
var _AppStore = __webpack_require__(4);
